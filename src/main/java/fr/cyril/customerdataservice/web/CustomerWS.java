 ...
 * 2024-02-06T10:19:08.267+01:00
 * Generated source version: 4.0.3
 *
 */
@WebServiceClient(name = "CustomerWS",
                  wsdlLocation = "file:/home/cyril/dev/projects/eclipse-workspace/account-data-service/src/main/resources/CustomerService.wsdl",
                  targetNamespace = "http://web.customerdataservice.cyril.fr/")
public class CustomerWS extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://web.customerdataservice.cyril.fr/", "CustomerWS");
    public final static QName CustomerSoapServicePort = new QName("http://web.customerdataservice.cyril.fr/", "CustomerSoapServicePort");
    static {
        URL url = null;
        try {
            url = new URL("file:/home/cyril/dev/projects/eclipse-workspace/account-data-service/src/main/resources/CustomerService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(CustomerWS.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/home/cyril/dev/projects/eclipse-workspace/account-data-service/src/main/resources/CustomerService.wsdl");
        }
        WSDL_LOCATION = url;
    }
